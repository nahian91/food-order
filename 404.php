<?php get_header();?>
    ...
    <!-- Start Breadcrumb 
    ============================================= -->
    <div class="breadcrumb-area bg-cover shadow dark text-center text-light" style="background-image: url(assets/img/shape/11-2.html);">
        <div class="container">
            <div class="row">
    ...
    <div class="error-page-area default-padding text-center bg-cover">
        <!-- Shape -->
        <div class="shape-left" style="background: url(assets/img/shape/44-left.html);"></div>
        <div class="shape-right" style="background: url(assets/img/shape/44-right.html);"></div>
        <!-- End Shape -->
        <div class="container">
            <div class="error-box">
                <div class="row">
